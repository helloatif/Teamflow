...
export const createProjectsRouter = () => {
  ...
  const projectService = new ProjectService(new PrismaProjectRepository(prisma), teamRepository, new ActivityLogService(new PrismaActivityLogRepository(prisma)));
